...
function buildThumbnails()
{
    ...
    var cathedralDiv = document.getElementById("cathedral");
    ...
    cathedralDiv.innerHTML = output;

    cathedralDiv.innerHTML = '<img src="' + imageList[0] + '" />; 

    fireworksDiv.innerHTML = output;

    fireworksDiv.innerHTML = '<img src="' + imageList[0] + '" />;
